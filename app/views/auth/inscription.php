...
<style>
  .promo-banner{
    ...
    padding:11px 13px;margin-bottom:20px;display:flex;gap:10px;align-items:center;
  }
  .promo-banner .pb-icon{
    width:32px;height:32px;border-radius:8px;background:var(--green-soft);color:var(--green);
    display:flex;align-items:center;justify-content:center;flex-shrink:0;
  }
  .promo-banner .pb-title{font-size:12.5px;font-weight:600;}
  .promo-banner .pb-sub{font-size:11px;color:var(--ink-soft);margin-top:1px;}
  .success-view{display:none;text-align:center;padding:8px 4px;}
  ...
  .success-view h1{font-size:19px;}
  .success-view p{color:var(--ink-soft);font-size:13px;margin-top:8px;line-height:1.5;}
  .next-steps{
    text-align:left;background:var(--paper);border:1px solid var(--line);border-radius:8px;
    padding:12px 14px;margin-top:18px;font-size:12.5px;color:var(--ink-soft);
  }
    ...
    <div class="login-card">
      ...
      <div class="form-view<?= $succes ? ' hidden' : '' ?>" id="formView">
        ...
        <div class="promo-banner">
          <div class="pb-icon">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="8" cy="8" r="3"/><circle cx="17" cy="9" r="2.6"/><path d="M2.5 20c.5-3.6 2.9-5.8 5.5-5.8s5 2.2 5.5 5.8M14 15c2.3.1 4 1.9 4.5 5"/></svg>
          </div>
          <div>
            <div class="pb-title">Formation Web — Sonatel Academy</div>
            <div class="pb-sub">Lien d'invitation du Gérant · code ABC12</div>
          </div>
        </div>
