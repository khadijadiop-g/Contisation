  ...
  <div class="main-col">
    ...
    <div class="screen">
      <div class="section-head">
        <div class="eyebrow">Bonjour Khadija</div>
        <h2>Mon avancement</h2>
        <p class="section-sub">Semaine 14 sur 40</p>
      </div>

      <div class="ring-wrap">
        <div class="ring"><span>35%</span></div>
        <div class="ring-info">
          <div class="ring-title">14 semaines payées</div>
          <div class="ring-sub">sur 40 · 42 000 F versés au total</div>
        </div>
      </div>

      <div class="card due-card">
        <div>
          <div class="due-label">Prochaine échéance</div>
          <div class="due-amount mono">3 000 F</div>
          <div class="due-date">Avant samedi 00h00</div>
        </div>
        <button class="btn btn-accent" style="width:auto;padding:11px 16px;color:#fff;">Je vais payer</button>
      </div>

      <div class="section-head">
        <div class="eyebrow">Campagnes en cours</div>
        <h2>Anniversaire — Juillet</h2>
      </div>
      <div class="card" style="padding:14px;display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;">
        <div>
          <div style="font-size:13.5px;font-weight:600;">Montant fixe · 1 000 F</div>
          <div style="font-size:12px;color:var(--ink-soft);margin-top:2px;">Échéance : dernière semaine du mois</div>
        </div>
        <span class="badge late">Non payé</span>
      </div>
      <div class="card" style="padding:14px;display:flex;justify-content:space-between;align-items:center;">
        <div>
          <div style="font-size:13.5px;font-weight:600;">Cas social — Décès famille Sarr</div>
          <div style="font-size:12px;color:var(--ink-soft);margin-top:2px;">Montant libre · clôture dans 3 jours</div>
        </div>
        <span class="badge ok">Déjà donné</span>
      </div>
    </div>
  </div>
